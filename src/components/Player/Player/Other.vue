<template>
    <div>
      ...
      <div class="picture_container" @mousewheel.stop.prevent="mousewheel" :style="{height: computedHeight+'px'}" @contextmenu.stop.prevent>
        ...
        <img class="picture-item" v-show="s.index===curIndex" v-for="s in options.source" :key="s.src" :src="s.src" draggable="false" onerror="this.src='./images/cannotpreview.png'" />
        <span class="player_text" v-if="curSource.text">{{curSource.text}}</span>
      </div>
